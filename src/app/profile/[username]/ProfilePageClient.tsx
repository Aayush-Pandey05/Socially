...
function ProfilePageClient({
  ...
  const [isUpadatingFollow, setIsUpdatingFollow] = useState(false);
  ...
  const handleSubmit = async () => {
    const formData = new FormData(); // this is a built in browser API to create a form data object
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-6">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {!currentUser ? (
                  ...
                  <Button
                    ...
                    onClick={() => setShowEditDailog(true)}
                  >
        ...
        <Dialog open={showEditDailog} onOpenChange={setShowEditDailog}>
